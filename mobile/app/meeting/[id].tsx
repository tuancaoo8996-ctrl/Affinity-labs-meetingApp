...
import { Meeting, Speaker } from '../../src/types';
import { getMeeting, subscribeMeetingStatus, updateSpeakers } from '../../src/services/meetingService';
import { Colors } from '../../src/constants/colors';
import PlaybackCard from '../../src/components/PlaybackCard';
...
export default function MeetingDetailScreen() {
  ...
  const handleRenameSpeaker = (speaker: Speaker) => {
    Alert.prompt(
      'Rename Speaker',
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        {/* Audio Playback */}
        {meeting.audio_url && meeting.status === 'done' && (
        ...
        {(meeting.status === 'pending' || meeting.status === 'processing') && (
          <View style={styles.processingBanner}>
            ...
            <Text style={styles.processingText}>
              {meeting.status === 'pending' ? 'Uploading…' : 'AI is processing your meeting…'}
            </Text>
          </View>
        )}
